...
begin
	...
	f_Q_next(1) <= ((not f_Q(2)) and (not f_Q(0)) and (not i_left) and i_right) or (f_Q(1) and (not f_Q(0))) or (f_Q(2) and (not f_Q(1)) and f_Q(0));
	f_Q_next(2) <= ((not f_Q(2)) and (not f_Q(1)) and (not f_Q(0)) and (not i_right) and i_left) or (f_Q(1) and (not f_Q(2)) and f_Q(0)) or (f_Q(2) and (not f_Q(1)) and f_Q(0)) or (f_Q(2) and (not f_Q(0)) and f_Q(1));
